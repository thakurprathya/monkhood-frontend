...
const FloatingCard = ({svg, value, label}) => {
    return (
        <div className='w-[89px] h-[104px] rounded-[10px] mx-3 sm-360:mx-2 flex flex-col justify-center items-center bg-[#fbfafa] shadow-[1.35417px_1.78208px_5.34625px_rgba(0,0,0,0.1),-1.35417px_1.08333px_67.7083px_-10.8333px_rgba(0,0,0,0.05)]'>
