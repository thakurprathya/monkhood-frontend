...
const Accordion = ({head, data, count}) => {
    ...
    return (
        <div className='mb-2'>
            <button onClick={HandleClick} className='w-[326px] h-[42px] sm-350:w-[300px] px-3 flex items-center justify-between rounded-[10px] border-[0.5px] border-solid border-[#D8D8D8] bg-[#fbfafa]'>
            ...
            {state?
                <div className='w-[326px] sm-350:w-[300px] py-2 px-4 bg-white rounded-[10px] border-[0.5px] border-solid border-[#f9f8f8]'>
